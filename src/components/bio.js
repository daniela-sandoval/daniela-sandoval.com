      ...
      <div className="bio-container">
        <div className="profile">
          ...
          <div className="bio-text">
            <p><span role="img" aria-label="cat">🐈</span> After graduating from St. John's University, my love for digital media led me down the rabbit hole of web development. With the help of the Flatiron School and a loving cohort, I am proud to call myself a Software Developer. I'm actively pursuing new opportunities to level up my coding skills as I commute all over NYC. As a developer, I hope to continue learning, but also help others learn to love code! </p>
            <p><span role="img" aria-label="cat">🐈</span> My first steps with coding actually began by trying to to figure out how to insert music players into Tumblr themes. Becoming a maker of digital spaces inspires me into creating applications that are not only unique experiences, but also functional. I love interacting with others especially when collaborating on projects because new prospectives open doors to new possibilities.</p>
